...
def login_info(username,password):
    ...
    login_button = driver.find_element(By.XPATH,'/html/body/form/table/tbody/tr[3]/td/table/tbody/tr/td[1]/input')
    username_field.send_keys(username)
    password_field.send_keys(password)
    login_button.click()

def rebooter():
    maintainence_field = driver.find_element(By.XPATH, '//*[@id="div_menu_left"]/ul[5]/li/a')
    maintainence_field.click()
    reboot_device_field = driver.find_element(By.XPATH, '//*[@id="div_menu_left"]/ul[5]/li[5]')
